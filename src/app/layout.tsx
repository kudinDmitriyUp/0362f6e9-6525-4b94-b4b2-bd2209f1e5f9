...
export const metadata: Metadata = {
  title: "AI Automation for Small Business | Voice Agents & Chatbots",
  description: "Implement AI voice agents, automations, and chatbots to streamline operations and reduce costs. Simple, fast setup designed for small businesses.",
  keywords: "AI automation, voice agents, chatbots, business automation, small business AI, customer service automation",
  metadataBase: new URL("https://aiautomationhub.com"),
  alternates: {
    canonical: "https://aiautomationhub.com"
  },
  openGraph: {
    title: "Transform Your Business with AI Automation",
    description: "Implement voice agents, AI automations, and chatbots designed for small businesses. Save time and reduce costs.",
    url: "https://aiautomationhub.com",
    siteName: "AI Automation Hub",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764622955810-jl00pr5o.jpg",
        alt: "AI Automation Hub Platform"
      }
    ]
  },
  twitter: {
    ...
    title: "Transform Your Business with AI Automation",
    description: "Voice agents, automations, and chatbots for small businesses.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764622955810-jl00pr5o.jpg"]
  },
  robots: {
    index: true,
    follow: true
